...
import band from '../assets/img/mirroredBand-CROP.jpg'
...
const Bio = () => (
    <Container style={{display:'flex', flexDirection:'column', alignItems:'center'}}>
        ...
        <p style={CONTAINER_STYLE}>
            <br/>
            <i style={{fontSize:24}}>Sleave is a dynamic three 
            piece whose sound brings together elements of alternative rock, 
            punk, and American hardcore while also being reminiscent of the 
            American grunge and emo movements of the 90's. </i>
            <br/>
            <br/>
            <span style={SPAN_STYLE}>
                ...
                The band then took a performing hiatus in 2018 to record what was rumored to be their first full length album. 
                The band worked tirelessly with the help of Pedro Aida of <a href='http://www.audioveriterva.com/' target='_blank' rel="noopener noreferrer">Audio Verite Studios</a> and <a href='http://andreasmagnusson.com/' target='_blank' rel='noopener noreferrer'>Andreas Magnusson</a>, both of whom they had worked with on previous releases.
                During this time, Daniel Salinas replaced Sam Mclelland on bass; and the current Sleave lineup was formed. 
                <br/>
                <br/>
